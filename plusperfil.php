...
?>
<head>
<title>AniFlix - Crie um perfil</title>
...
<div id="divaddperfil">
<h1 id="selectdiv">Crie um perfil</h1>
<div id="img-add">
...
<input id="inputs" type="text" name="nome" placeholder="Coloque um nome" />

<input type="submit" id="quemsubmit" value="Criar" name="criar">
...
$busca  = "SELECT id FROM ani_perfil WHERE id = '".$username."'";
